  ...
  <v-dialog v-model="show" persistent max-width="600px">
    <v-card class="searchDialog">
      ...
      <div class="inputsSearch">
        ...
        <div class="searchFormInputs">
          <div>
            <v-select v-model="fuel_type" label="Fuel Type" :items="['Petrol', 'Diesel', 'LPG']"></v-select>
          </div>
        </div>
        <div class="searchFormInputs">
          <div>
      ...
      <div class="checkBoxSearch">
        ...
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Sports suspension'"
          class="mx-2"
        ...
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Voice control'"
          class="mx-2"
          label="Voice control"
        ></v-checkbox>
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Heated steering wheel'"
          class="mx-2"
        ...
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Digital cockpit'"
          class="mx-2"
        ...
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Start-stop system'"
          class="mx-2"
        ...
        <v-checkbox
          ...
          v-bind:false-value="'x'"
          v-bind:true-value="'Bi-xenon headlights'"
          class="mx-2"
...
export default {
  ...
  methods: {
    searchCar() {
      ...
      axios
        .get(
          `http://localhost:8080/searchCar/s?zemlja=${this.country}&karoserija=${this.vehicle_type}&gorivo=${this.fuel_type}&menjac=${this.transmission}&oprema=${this.equipment}&sedista=${this.interior_material}&s1=${this.specific[0]}&s2=${this.specific[1]}&s3=${this.specific[2]}`
        )
        .then(response => {
